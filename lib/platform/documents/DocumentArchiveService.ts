...
import { generateInvoicePdfBuffer }      from '@/lib/platform/pdf/serverInvoicePdf'
import {
  ...
  type SimpleItem,
} from '@/lib/platform/pdf/serverPdfGenerators'
import { diskAdapter }                   from '@/lib/platform/storage/LocalDiskAdapter'
import { resolveDocumentPath }           from '@/lib/platform/storage/PathResolver'
import type { StorageAdapter }           from '@/lib/platform/storage/StorageAdapter'
import type { CompanySettings }          from '@/lib/platform/pdf/types'
