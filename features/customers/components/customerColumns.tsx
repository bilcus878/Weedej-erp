...
export function createCustomerColumns(filters: FiltersResult<Customer>): ColumnDef<Customer>[] {
  ...
  return [
    ...
    },
    {
      ...
      // hook uses key 'web' for this filter
      filterNode: <FilterInput className="w-full text-center" value={v['web'] ?? ''} onChange={val => s('web', val)} placeholder="Web..." />,
